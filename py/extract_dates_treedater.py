...
if '__main__' == __name__:
    ...
    M_date = 2019
    df[['date', 'lower', 'upper']] = df[params.date_col].apply(lambda _: date2years(_, None, m_date, M_date)).apply(pd.Series)
    df[['date', 'lower', 'upper']].to_csv(params.dates, header=False)
